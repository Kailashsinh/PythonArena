...
const features = [
  {
    ...
    description:
      "Pure Python execution environment with secure sandboxing. Focus on one language, master it.",
  },
  {
    icon: EyeOff,
    title: "Hidden Test Cases",
    description:
      "Your code is validated against hidden test cases to ensure correctness beyond examples.",
  },
  {
    icon: Zap,
    title: "Instant Verdicts",
    description:
      "Get immediate feedback on your submissions. Accepted, Wrong Answer, or Runtime Error - know instantly.",
  },
];
          ...
          <div className="container relative z-10">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground mb-14 max-w-2xl mx-auto">
                Python-only coding practice platform. Solve problems, validate
                against hidden test cases, and get instant verdicts.
              </p>
            </motion.div>
              ...
              <div className="rounded-xl border border-border bg-card overflow-hidden shadow-2xl">
                ...
                <pre className="p-6 text-sm font-mono overflow-x-auto">
                  <code>
                    ...
                    <span className="text-foreground"> seen:</span>
                    {"\n"}
                    <span className="text-python-blue">
                      {"            return"}
                    </span>
                    <span className="text-foreground">
                      {" [seen[complement], i]"}
            ...
            {/* CTA Buttons BELOW Code Preview */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <div className="container">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                ...
                <span className="text-python-blue">Area</span>?
              </h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {features.map((feature, index) => (
                ...
                >
                  <Card className="h-full border-border bg-card hover:border-python-blue/50 transition">
          ...
          <div className="container">
            ...
            >
              ...
              <p className="text-muted-foreground text-lg mb-8">
                Jump into our collection of Python problems and start building
                your algorithmic thinking skills.
              </p>
              <Link to="/problems">
                <Button variant="hero" size="xl" className="group">
                  Browse Problems
